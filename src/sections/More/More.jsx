    ...
    <section id="more">
      ...
      <ul>
        <li className='more-item'>
          Want to see how I <b>Leetcode</b>? Check <a href='https://leetcode.com/u/ngada/' target='_blank'>this</a>
        </li>
        <li className='more-item'>
        ...
        <li className='more-item'>
          I absolutely love playing the Piano whenever I get the opportunity or time, not that I am great at it, but it's comforting and awakens a different side of me
        </li>
        <li className='more-item'>
          I love playing, watching, and going crazy about Cricket (Indian Sport). It is a part of my core childhood memories and has been my favorite amongst all the sports that I have ever tried and played
        </li>
        <li className='more-item'>
          I someday aim to own a business or start a company, and every step I take, I try to take in that direction - be it communcation, collaboration, business understanding, domain understanding, talking to people, learning new ways of learning, making mistakes, and sometimes even watching too much Shark Tank
        </li>
